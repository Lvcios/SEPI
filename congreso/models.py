...
class Evento(models.Model):
	Nombre = models.CharField(max_length = 250, verbose_name="Nombre Completo del Evento",)
	...
	Hora_I = models.TimeField(auto_now = False,verbose_name="Hora de inicio *Opcional",null=True, blank=True)
	Fecha_F = models.DateField(auto_now = False,verbose_name="Fecha de Finalización *Opcional",null=True, blank=True)
	Hora_F = models.TimeField(auto_now = False,verbose_name="Hora de finalización *Opcional",null=True, blank=True)
	Pais = CountryField(verbose_name="Pais")
	Estado = models.CharField(max_length = 100, verbose_name="Estado, Provincia o Región")
	Municipio = models.CharField(max_length = 100, verbose_name="Municipio, Delegación o Ciudad")
