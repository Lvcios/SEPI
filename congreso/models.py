...
class Evento(models.Model):
	...
	Descripcion = models.TextField(max_length = 100, verbose_name="Breve descripci&oacute;n del evento")
	...
	Municipio = models.CharField(max_length = 100, verbose_name="Municipio/Delegaci&oacute;n/Ciudad")
	Direccion = models.TextField(verbose_name="Domicilio")
	Referencias = models.TextField(verbose_name="Referencias y/o Detalles",null=True,blank = True)
